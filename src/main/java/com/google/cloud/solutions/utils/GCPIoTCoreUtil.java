...
/**
 * Utility class from getting configurations stored as metadata in Cloud IoT Core.
 * Setting up the service object that calls Cloud IoT Core api.
 * Returns the configuration value based on metadata key.
 * Previous fetched metadata are cached
 */
