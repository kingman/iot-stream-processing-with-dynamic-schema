...
/**
 * Get the table destinations from Cloud IoT Core metadata and create TableDestination object from the configuration.
 * Previous fetched destinations are cached.
 */
